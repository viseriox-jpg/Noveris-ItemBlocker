...
public final class RestrictionAdminScreen extends Screen {
    ...
    private int tabsY, tabWidth, addX, addY, addWidth, addHeight, modalLeft, modalTop, modalWidth;
    @Override protected void init() {
        ...
        if (addModal) { modalWidth = Math.min(620, panelWidth - 40); modalLeft = left + (panelWidth - modalWidth) / 2; modalTop = top + 88; itemInput = new EditBox(font, modalLeft + 18, modalTop + 46, modalWidth - 36, 20, Component.literal("ResourceLocation")); itemInput.setHint(Component.literal("minecraft:netherite_sword")); addRenderableWidget(itemInput); itemInput.setFocused(true); }
    }
